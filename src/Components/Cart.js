...
import { dispatchRemoveFromcart } from './Cards/action';
export default function Cart() {
   ...
   /*  console.log("props" , props) 
    ...
    const Removefromreducer=  (productData1) =>{
        console.log("hello")
                                            ...
                                            <td >
                                                ...
                                                <td>
                                                 <div> 
                                                    ...
                                                    <button   className=" btn btn-danger text-white" onClick={()=>Removefromreducer(productsData)}>Remove </button>
                                                </div> 
                                                </td>
